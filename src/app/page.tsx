...
<div
  className="ml-0 mr-auto max-w-md p-4 bg-gray-100 rounded-lg mb-12 md:mb-8 relative overflow-hidden flex items-center justify-between"
  style={{
...
>
  <div className="flex-1 pe-3">
    <h3 className="font-bold text-base text-gray-800">Item Grátis</h3>

    {/* parágrafo com fonte menor */}
    <p className="text-xs text-gray-600">Resgate aqui seus itens exclusivos grátis</p>

    {/* botão com texto menor e padding ajustado */}
    <Button
      variant="destructive"
      className="mt-3 text-[13px] px-2 py-0.5"
  ...
  {/* cubo mantido no mesmo tamanho (48x48) */}
  <div className="flex-shrink-0 ms-3 text-center">
    ...
    <div className="text-xs text-gray-700 mt-1 inline-flex items-center gap-1">
      Cubo mágico <InfoIcon />
    </div>
  </div>
</div>
               ...
               <span className="inline-flex items-center text-xs/none font-normal text-primary md:text-sm/none">
  + Bônus 
  <Image 
